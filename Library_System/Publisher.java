...
public class Publisher extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = conn.prepareStatement("insert into publisher(publisher,address,phone)value(?,?,?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst = conn.prepareStatement("update publisher set publisher = ?, address = ?, phone = ? where id = ?");
            pst.setString(1,name);
            pst.setString(2,address);
            pst.setString(3,phone);
            pst.setInt(4,id);
